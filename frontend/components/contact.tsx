      ...
      <div className="flex flex-col md:flex-row gap-6 lg:gap-8 rounded-xl overflow-hidden">
        ...
        <div className="w-full md:w-2/5 p-6 sm:p-8 glass-card">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4 hover-lift transition-all">
              <div className="w-12 h-12 rounded-full bg-[#7b3fe4]/10 flex items-center justify-center text-[#7b3fe4]">
            ...
            <div className="flex items-center gap-4 hover-lift transition-all">
              <div className="w-12 h-12 rounded-full bg-[#b799ff]/10 flex items-center justify-center text-[#b799ff]">
          ...
          <div className="mt-8 pt-6 border-t border-[#1e1b2f]">
            ...
            <div className="flex gap-4 mt-3">
              <a href="https://www.linkedin.com/in/kush2012bhardwaj/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#1e1b2f] flex items-center justify-center text-[#a5a5c8] hover:text-[#7b3fe4] hover-lift transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect width="4" height="12" x="2" y="9"></rect><circle cx="4" cy="4" r="2"></circle></svg>
              </a>
              <a href="https://github.com/Kush05Bhardwaj" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#1e1b2f] flex items-center justify-center text-[#a5a5c8] hover:text-[#7b3fe4] hover-lift transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"></path><path d="M9 18c-4.51 2-5-2-7-2"></path></svg>
              </a>
              <a href="https://x.com/Kush05Bhardwaj" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#1e1b2f] flex items-center justify-center text-[#a5a5c8] hover:text-[#7b3fe4] hover-lift transition-all">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input 
                  ...
                  required
                  placeholder=""
                  className="bg-[#1e1b2f]/30 border-[#1e1b2f] focus:border-[#7b3fe4] focus:ring-[#7b3fe4]/20"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <Textarea 
                ...
                required
                placeholder=""
                className="bg-[#1e1b2f]/30 border-[#1e1b2f] focus:border-[#7b3fe4] focus:ring-[#7b3fe4]/20 resize-none"
              />
            </div>
            ...
            <div>
              <Button 
                ...
                className="w-full bg-gradient-to-r from-[#7b3fe4] to-[#b799ff] hover:from-[#6b2fd4] hover:to-[#a688ee] text-white font-medium py-2 px-4 rounded-md transition-colors flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <>
