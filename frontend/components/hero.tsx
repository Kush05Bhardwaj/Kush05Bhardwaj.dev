    ...
    <section id="home" className="py-12 md:py-20 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <Button 
              asChild 
              size="lg"
              className="bg-[#7b3fe4] hover:bg-[#6b2fd4] text-white shadow-lg shadow-[#7b3fe4]/20 hover:shadow-[#7b3fe4]/30 transition-all duration-200"
            >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="border-[#1e1b2f] text-[#e9e9f5] hover:bg-[#1e1b2f] hover:text-white hover:border-[#7b3fe4]/30 transition-all duration-200"
            >
          ...
          <div className="flex gap-3 pt-6">
            <a 
              ...
              className="w-10 h-10 rounded-lg bg-[#1e1b2f] border border-[#1e1b2f] flex items-center justify-center text-[#a5a5c8] hover:text-[#7b3fe4] hover:border-[#7b3fe4]/50 hover:bg-[#1e1b2f]/80 transition-all duration-200"
              aria-label="LinkedIn"
            >
      ...
      <div className="relative">
        <div className="relative w-[280px] h-[280px] sm:w-[320px] sm:h-[320px]">
          ...
          {/* Image container */}
          <div className="relative w-full h-full rounded-full overflow-hidden border-2 border-[#1e1b2f] bg-[#0a0612]/50 shadow-xl">
            <Image
